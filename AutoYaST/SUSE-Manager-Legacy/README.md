# SUSE Manager Legacy (5.0 or older) AutoYaST Profiles

This directory contains AutoYaST profiles for SUSE Manager version 5.0 and older.

**Note:** These profiles are compatible with SUSE Multi-Linux Manager, but typically should not be needed as newer profiles are available.
